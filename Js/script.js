...
const displayCountries = (data) => {
    ...
    data.forEach(country => {
        const singleCard = `<a href="Rest-countries-api-project/country.html?name=${country.name}" class="block rounded-br-md rounded-bl-md dark:bg-header dark:text-white shadow-lg dark:shadow-none">
            <div class="w-full">
